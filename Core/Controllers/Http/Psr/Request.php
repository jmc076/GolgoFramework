...
use Core\Controllers\Http\Psr\Interfaces\ServerRequestInterface;
...
class Request extends Message implements ServerRequestInterface
{
    ...
    public static function createFromGlobals(array $globals)
    {
        ...
        $request = new static($method, $uri, $headers, $serverParams, $body, $uploadedFiles);
     ...
     * match operations; the results of
