						...
						<form id="js-login-form" class="login-form">
							...
							<div class="card card-login">
								...
								<div class="card-content">
									...
									<a href="/GolgoFramework/dashboard" type="submit" class="btn btn-primary main-button-color">
									<i class="material-icons">exit_to_app</i>
									{$i18n["admin-login"].continue}<div class="ripple-container"></div></a>
								</div>
									<div class="footer text-center">
									<a href="/GolgoFramework/exit" type="submit" class="btn btn-primary main-button-color">
