	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
		...
		<div class="card-header" data-background-color="purple">
			<div class="mdl-tabs__tab-bar">
				<a href="#starks-panel" class="mdl-tabs__tab is-active"><i class="material-icons">bug_report</i>Starks</a>
				 <a href="#lannisters-panel" class="mdl-tabs__tab"><i class="material-icons">bug_report</i>Lannisters</a> 
				 <a href="#targaryens-panel" class="mdl-tabs__tab"><i class="material-icons">bug_report</i>Targaryens</a>
			</div>
		</div>
