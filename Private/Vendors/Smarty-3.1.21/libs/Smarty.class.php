...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('Private' . DS. 'Views'. DS . 'tpls'. DS)
            ->setCompileDir('Private' . DS. 'Views'. DS . 'tpls_c'. DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir(ROOT_PATH . 'Private'. DS . 'Vendors/Smarty-3.1.21/SmartyCache'. DS)
            ->setConfigDir(ROOT_PATH . 'Private'. DS . 'Vendors/Smarty-3.1.21/SmartyConfig'. DS);
